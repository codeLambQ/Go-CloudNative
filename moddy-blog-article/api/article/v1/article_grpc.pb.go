...
const (
	...
	ArticleService_ListArticle_FullMethodName   = "/article.v1.ArticleService/ListArticle"
)
...
func (c *articleServiceClient) ListArticle(ctx context.Context, in *ListArticleRequest, opts ...grpc.CallOption) (*ListArticleReply, error) {
	...
	err := c.cc.Invoke(ctx, ArticleService_ListArticle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
