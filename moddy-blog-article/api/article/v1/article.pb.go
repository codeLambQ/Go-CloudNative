...
const file_article_v1_article_proto_rawDesc = "" +
	...
	"\bArticles\x18\x01 \x03(\v2\x13.article.v1.ArticleR\bArticles2\xa1\x04\n" +
	...
	"\n" +
	"GetArticle\x12\x1d.article.v1.GetArticleRequest\x1a\x1b.article.v1.GetArticleReply\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/article/{id}\x12c\n" +
	"\vListArticle\x12\x1e.article.v1.ListArticleRequest\x1a\x1c.article.v1.ListArticleReply\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\x12\v/v1/articleB&Z$moddy-blog-article/api/article/v1;v1b\x06proto3"
...
var file_article_v1_article_proto_depIdxs = []int32{
	...
	2,  // 9: article.v1.ArticleService.CreateArticle:output_type -> article.v1.CreateArticleReply
	4,  // 10: article.v1.ArticleService.UpdateArticle:output_type -> article.v1.UpdateArticleReply
	6,  // 11: article.v1.ArticleService.DeleteArticle:output_type -> article.v1.DeleteArticleReply
	8,  // 12: article.v1.ArticleService.GetArticle:output_type -> article.v1.GetArticleReply
	10, // 13: article.v1.ArticleService.ListArticle:output_type -> article.v1.ListArticleReply
