...
import (
	"context"
	"moddy-blog-article/internal/data/ent/article"
	"moddy-blog-article/internal/data/ent/predicate"
...
func (_d *ArticleDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(article.Table, sqlgraph.NewFieldSpec(article.FieldID, field.TypeInt64))
